...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='内容表，用于存放比如文章、帖子、商品、问答等用户自定义模型内容。也用来存放比如菜单、购物车、消费记录等系统模型。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jpress_mapping` (
  ...
  KEY `content_id` (`content_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='内容和分类的多对多映射关系。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_mapping` VALUES (1,7,1),(2,9,7),(3,10,8),(4,11,9),(5,12,10),(6,13,11),(7,14,12),(8,15,2),(9,16,3),(10,17,4),(11,18,5),(12,19,6),(13,20,14),(17,24,13);
...
CREATE TABLE `jpress_metadata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COMMENT='元数据表，用来对其他表的字段扩充。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-12 20:18:09
