...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COMMENT='内容表，用于存放比如文章、帖子、商品、问答等用户自定义模型内容。也用来存放比如菜单、购物车、消费记录等系统模型。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jpress_mapping` (
  ...
  KEY `content_id` (`content_id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COMMENT='内容和分类的多对多映射关系。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_mapping` VALUES (2,9,7),(3,10,8),(4,11,9),(5,12,10),(6,13,11),(8,15,2),(9,16,3),(10,17,4),(11,18,5),(12,19,6),(19,28,3),(25,14,12),(35,38,33),(36,38,24),(37,24,33),(38,24,24),(39,20,33),(40,20,23),(41,4,33),(42,4,22),(46,2,22),(47,2,33),(48,2,22),(56,35,34);
...
CREATE TABLE `jpress_metadata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 COMMENT='元数据表，用来对其他表的字段扩充。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_metadata` VALUES (1,'',NULL,'content',2),(2,'_meta2',NULL,'content',2),(3,'_meta1','长宁','content',5),(4,'_meta2','2016-10-11','content',5),(5,'_meta3','环境保护','content',5),(6,'_meta4','北航','content',5),(7,'_meta1','长宁长宁！！！','content',6),(8,'_meta6','2016-8-8','content',6),(10,'_meta1','长宁','content',7),(11,'_meta2','2016-10-15','content',7),(12,'_meta3','文化','content',7),(13,'_meta4','北航','content',7),(14,'_meta1','长宁','content',9),(17,'_meta1','长宁','content',10),(20,'_meta1','长宁','content',11),(23,'_meta1','cn','content',12),(26,'_meta1','cn','content',13),(29,'_meta1','cn','content',14),(32,'_meta1','dd','content',15),(33,'_meta2','dd','content',15),(34,'_meta3','体育','content',15),(35,'_meta4','dd','content',15),(36,'_meta1','dd','content',16),(37,'_meta2','dd','content',16),(38,'_meta3','教育','content',16),(39,'_meta4','dd','content',16),(40,'_meta1','dd','content',17),(41,'_meta2','dd','content',17),(42,'_meta3','卫生医疗','content',17),(43,'_meta4','dd','content',17),(44,'_meta1','dd','content',18),(45,'_meta2','dd','content',18),(46,'_meta3','社区','content',18),(47,'_meta4','dd','content',18),(48,'_meta1','dd','content',19),(49,'_meta2','dd','content',19),(50,'_meta3','社区服务','content',19),(51,'_meta4','dd','content',19),(52,'_meta1','长宁区','content',27),(53,'_meta2','2016-11-15','content',27),(54,'_meta3','环境保护','content',27),(55,'_meta4','bh','content',27),(56,'_meta1','才能','content',28),(57,'_meta2','2016-11-11','content',28),(58,'_meta3','教育','content',28),(59,'_meta4','bh','content',28),(60,'_meta1','飞机开始的回归的健康撒谎都看见爱上空间大师','content',34),(61,'_meta2',NULL,'content',34),(62,'_meta3',NULL,'content',34),(63,'_meta4',NULL,'content',34),(64,'_meta1',NULL,'content',35),(67,'_meta1',NULL,'content',36),(70,'_meta1',NULL,'content',37),(73,'_meta1','体育基地地址','content',37),(74,'_meta2',NULL,'content',37),(75,'_meta3',NULL,'content',37),(76,'_meta1','社区地址1','content',39),(77,'_meta2',NULL,'content',39),(78,'_meta3',NULL,'content',39),(79,'_meta1',NULL,'content',35),(80,'_meta2',NULL,'content',35),(81,'_meta3',NULL,'content',35);
...
CREATE TABLE `jpress_taxonomy` (
  ...
  KEY `content_module` (`content_module`),
  KEY `created` (`created`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COMMENT='分类表。标签、专题、类别等都属于taxonomy。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-20 10:58:48
