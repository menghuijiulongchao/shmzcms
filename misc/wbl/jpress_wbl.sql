...
CREATE TABLE `jpress_mapping` (
  ...
  KEY `content_id` (`content_id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COMMENT='内容和分类的多对多映射关系。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_mapping` VALUES (1,7,1),(2,9,7),(3,10,8),(4,11,9),(5,12,10),(6,13,11),(8,15,2),(9,16,3),(10,17,4),(11,18,5),(12,19,6),(18,27,1),(19,28,3),(21,2,22),(22,4,22),(23,20,23),(24,24,24),(25,14,12),(28,34,1),(29,36,28),(30,35,26),(31,37,29),(32,38,24);
...
CREATE TABLE `jpress_taxonomy` (
  ...
  KEY `content_module` (`content_module`),
  KEY `created` (`created`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COMMENT='分类表。标签、专题、类别等都属于taxonomy。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-19 20:14:12
