...
--
-- Host: localhost    Database: jpress_test
-- ------------------------------------------------------
...
CREATE TABLE `jpress_mapping` (
  ...
  KEY `content_id` (`content_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='内容和分类的多对多映射关系。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_mapping` VALUES (1,7,1),(2,9,7),(3,10,8),(4,11,9),(5,12,10),(6,13,11),(7,14,12),(8,15,2),(9,16,3),(10,17,4),(11,18,5),(12,19,6),(13,20,14),(17,24,13),(18,27,1),(19,28,3);
...
CREATE TABLE `jpress_metadata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COMMENT='元数据表，用来对其他表的字段扩充。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jpress_taxonomy` (
  ...
  KEY `content_module` (`content_module`),
  KEY `created` (`created`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='分类表。标签、专题、类别等都属于taxonomy。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jpress_taxonomy` VALUES (1,'文化',NULL,'wenhua','category',NULL,'huodong',2,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'体育',NULL,'tiyu','category',NULL,'huodong',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'教育',NULL,'jiaoyu','category',NULL,'huodong',2,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'卫生医疗',NULL,'weishengyiliao','category',NULL,'huodong',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'社区',NULL,'shequ','category',NULL,'huodong',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'社区服务',NULL,'shequfuwu','category',NULL,'huodong',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'文化',NULL,'wenhua','category',NULL,'jidi',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,'体育',NULL,'tiyu','category',NULL,'jidi',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,'教育',NULL,'jiaoyu','category',NULL,'jidi',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,'卫生医疗',NULL,'weishengyiliao','category',NULL,'jidi',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(11,'社区',NULL,'shequ','category',NULL,'jidi',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(12,'社区服务',NULL,'shequfuwu','category',NULL,'jidi',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(13,'信息公告',NULL,'xxgg','category',NULL,'article',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(14,'新闻资讯',NULL,'xwzx','category',NULL,'article',1,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(15,'政策法规',NULL,'zzfg','category',NULL,'article',0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2016-10-13 11:15:57
